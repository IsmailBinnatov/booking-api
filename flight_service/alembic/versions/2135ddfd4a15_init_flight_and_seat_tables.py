...
def upgrade() -> None:
    ...
    sa.Column('departure_from', sa.String(length=4), nullable=False),
    sa.Column('arrival_to', sa.String(length=4), nullable=False),
